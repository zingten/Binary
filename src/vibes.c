...
static const uint32_t vibe_quarter_data[] = {100, 250, 300, 250, 100, 250, 100};
static VibePattern vibe_quarter = {
	.durations = vibe_quarter_data,
	.num_segments = 7
};
static const uint32_t vibe_half_data[] = {100, 250, 100, 250, 300, 250, 100};
static VibePattern vibe_half = {
	.durations = vibe_half_data,
	.num_segments = 7
};
static const uint32_t vibe_threequarter_data[] = {100, 250, 100, 250, 100, 250, 300};
